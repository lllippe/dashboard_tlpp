...
class ValorAbertoService {
  static const String resource = "vaberto/";
  ...
  Future<List<ValorAberto>> getAll() async {
    ...
    List<ValorAberto> result = [];

    List<dynamic> jsonList = json.decode(response.body);

    for (var jsonMap in jsonList) {
      result.add(ValorAberto.fromMap(jsonMap));
    }
